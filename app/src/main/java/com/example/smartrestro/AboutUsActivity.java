...
public class AboutUsActivity extends AppCompatActivity
    ...
    private void logout() {
        ...
        Toast.makeText(AboutUsActivity.this, "Logged Out Successfully", Toast.LENGTH_SHORT).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent=new Intent(AboutUsActivity.this,PromotionActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_menus) {
            Intent intent=new Intent(AboutUsActivity.this,MenuActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_order) {
            Intent intent=new Intent(AboutUsActivity.this,MyOrderActivity.class);
            startActivity(intent);
            ...
            Intent intent=new Intent(AboutUsActivity.this,ShippingPaymentActivity.class);
            startActivity(intent);
