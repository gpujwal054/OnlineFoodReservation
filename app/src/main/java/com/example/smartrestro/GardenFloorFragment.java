 ...
 */
public class GardenFloorFragment extends Fragment implements View.OnClickListener {
    Button tab1,tab2,tab3,tab4,tab5,tab6,tab7,tab8,tab9;


    public GardenFloorFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_garden_floor, container, false);
